...
function Marquee() {
  const items = [
    "Private Suite — Nottingham", "By Appointment Only",
    "Booksy · 7-day window", "NG1 · Flying Horse Walk", "Tue–Fri · 09:00–19:00", "Sat · 09:00–17:00",
  ];
  ...
  return (
    <footer className="foot">
      <div className="foot-grid">
        <div>
          ...
          <div style={{ maxWidth: "32ch", lineHeight: 1.8, color: "var(--ink-soft)", fontSize: 11, letterSpacing: "0.04em" }}>
            A private barber suite at Flying Horse Walk, Nottingham. Sharp cuts, hot-towel shaves — by appointment only.
          </div>
        ...
        <div>
          <h4>Visit</h4>
          <ul>
            <li>Suite 101, Phenix Salon</li>
            <li>7 Flying Horse Walk</li>
            <li>Nottingham NG1 2HN</li>
            <li style={{ marginTop: 12, color: "var(--accent)" }}>Tue–Fri · 09:00–19:00</li>
            <li style={{ color: "var(--accent)" }}>Sat · 09:00–17:00</li>
        ...
        <div>
          ...
          <ul>
            ...
            <li><a href="https://www.instagram.com/manvsmanbarbers" target="_blank" rel="noopener">@manvsmanbarbers</a></li>
            <li><a href="https://www.tiktok.com/@manvsmanbarbers" target="_blank" rel="noopener">TikTok</a></li>
            <li><a href="https://manvsmanbarbers.booksy.com/a/" target="_blank" rel="noopener">Booksy</a></li>
          </ul>
        </div>
        <div>
          <h4>Index</h4>
      ...
      <div className="foot-bottom">
        <span>© 2026 Man vs Man Barbers</span>
        <span>No cookies, no popups</span>
      </div>
    </footer>
  );
}
  ...
  return (
    <button
      ...
      style={{
        ...
        appearance: 'none', border: '1px solid rgba(201,168,76,0.35)',
        borderRadius: 8, background: 'rgba(13,10,6,0.82)',
        backdropFilter: 'blur(12px)', color: 'rgba(201,168,76,0.85)',
        fontFamily: 'ui-sans-serif,system-ui,sans-serif', fontSize: 11,
        fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase',
        padding: '7px 12px', cursor: 'pointer', lineHeight: 1,
      }}
    >
      ⚙ Tweaks
    </button>
...
Object.assign(window, { TopBar, Marquee, Footer, MvmTweaks, TweaksTrigger, NAV, Wordmark, CalIcon, useMvmTweaks, MVM_TWEAK_DEFAULTS });
